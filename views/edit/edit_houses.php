...
<div id="admin-content">
    ...
    <form name="more_info" id="more-info" action="<?=URL_ADMIN?>save/<?=$url[3]?>/" method="POST">
        ...
        <div class="img-block-html">
            <label>Картинка домов</label><br>
            <span class="tips-img">1920 x 949px </span>
        ...
        <div class="img-block-html">
            <label>Картинка генплана</label><br>
        ...
        <div class="img-block-html">
            <label>Картинка домов (моб)</label><br>
            <span class="tips-img">Размер 984*949px</span>
