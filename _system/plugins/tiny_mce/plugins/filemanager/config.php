<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = $_SERVER['DOCUMENT_ROOT']."/public/files/";//'../../../../../../files/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT']."/public/files/";//'../../../../../../uploads/files/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
        $mcFileManagerConfig['filesystem.include_directory_pattern'] = '';
        $mcFileManagerConfig['filesystem.exclude_directory_pattern'] = '/^_thumb$/i';
        ...
        $mcFileManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,bmp,swf,mov,avi,mpg,mpeg,flv,pdf,doc,docx,xlsx,xls,pptx,pub,zip,rar,7z,mp3,txt";
        ...
        // Authenication
        $mcFileManagerConfig['authenticator'] = "SessionAuthenticator"; //"BaseAuthenticator";
