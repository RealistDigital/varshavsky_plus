<?php
        ...
        $mcImageManagerConfig['createdir.include_directory_pattern'] = '';//$_SERVER['DOCUMENT_ROOT'].'/plugins/tiny_mce/';
        ...
        $mcImageManagerConfig['filesystem.path'] = $_SERVER['DOCUMENT_ROOT']."/public/files/"; //'../../../../../../uploads/images/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT']."/public/files/"; //'../../../../../../uploads/images/'; // absolute or relative from this script path, required.
        $mcImageManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
        $mcImageManagerConfig['filesystem.include_directory_pattern'] = '';
        $mcImageManagerConfig['filesystem.exclude_directory_pattern'] = '/^_thumb$/i';
        ...
        $mcImageManagerConfig['thumbnail.folder'] = "_thumb"; // required, exclude this folder with file pattern '/^mcith$/i' if you don't want it to show
        $mcImageManagerConfig['thumbnail.prefix'] = "thumb_"; //
        ...
        // Authenication
        $mcImageManagerConfig['authenticator'] = "SessionAuthenticator";//"BaseAuthenticator";
        ...
        $mcImageManagerConfig['history.max'] = 20; // 10 is default.z
?>