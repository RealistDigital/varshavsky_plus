...
(function($){
    ...
    var methods = {
        ...
        mouseMove : function() {
            var eventMouse  = true; 
            // mouse down
            settings.containerPanorame.unbind('mousedown'); // clear event
            settings.containerPanorame.mousedown(function(eventDown){
                var costForDirection = 0;
                eventMouse = true;
                
                // check mouse up
                settings.containerPanorame.unbind('mouseup');
                settings.containerPanorame.mouseup(function(){
                ...
                // mouse moving
                settings.containerPanorame.unbind('mousemove'); // clear event
                settings.containerPanorame.mousemove(function(eventMove){
        ...
        auto : function () {
            ...
            setTimeout(function(){
                ...
                // delete inteval
                settings.containerPanorame.click(function(){
                    clearInterval(intevalFrame);
                });
            }, settings.autoDelay);   
        },
